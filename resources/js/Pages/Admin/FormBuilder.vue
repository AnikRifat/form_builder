                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="px-3 mb-6 w-full md:w-1/3 md:mb-0">
                                            ...
                                            <input v-model="form.title" type="text"
                                                class="px-4 py-2 mt-1 w-full rounded-md border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        ...
                                        <div v-for="field in fieldTypes" :key="field.type"
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    ...
                                                    <svg v-if="field.type === 'text'" xmlns="http://www.w3.org/2000/svg"
